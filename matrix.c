...
int free_matrix(int** matrix, int row, int col)
{
	...
	//matrix가 NULL일경우 NULL을 반환하는 후처리 함수
	if (matrix == NULL) {
...
int transpose_matrix(int** matrix, int** matrix_t, int row, int col)
{
	...
	//matrix_t가 NULL일경우 NULL을 반환하는 후처리 함수
	if (matrix_t == NULL) {
...
int addition_matrix(int** matrix_a, int** matrix_b, int** matrix_sum, int row, int col)
{
	...
	//matrix_sum가 NULL일경우 NULL을 반환하는 후처리 함수
	if (matrix_sum == NULL) {
...
int subtraction_matrix(int** matrix_a, int** matrix_b, int** matrix_sub, int row, int col)
{
	...
	//matrix_sub가 NULL일경우 NULL을 반환하는 후처리 함수
	if (matrix_sub == NULL) {
...
int multiply_matrix(int** matrix_a, int** matrix_t, int** matrix_axt, int row, int col)
{
	...
	//matrix_axt가 NULL일경우 NULL을 반환하는 후처리 함수
	if (matrix_axt == NULL) {
